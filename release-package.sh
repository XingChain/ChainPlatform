...
then
echo obfuscate
/opt/proguard/bin/proguard.sh @cid.pro
...
cd -
zip -q -X -r ${PACKAGE}.zip ${APPLICATION} -x \*/.idea/\* \*/.gitignore \*/.git/\* \*/\*.log \*.iml ${APPLICATION}/conf/cid.properties ${APPLICATION}/conf/logging.properties ${APPLICATION}/conf/localstorage/\*
rm -rf ${APPLICATION}
...
echo >> ${CHANGELOG}
echo "https://www.chainid.io/" >> ${CHANGELOG}
echo >> ${CHANGELOG}
...
#echo "The exe and dmg packages must have a digital signature by \"Stichting CID\"." >> ${CHANGELOG}
