...
import cid.Cid;
import cid.Shuffler;
import cid.Shuffling;
import cid.ShufflingTransaction;
import cid.Tester;
import cid.Transaction;
import cid.crypto.AnonymouslyEncryptedData;
...
import static cid.http.shuffling.ShufflingUtil.ALICE_RECIPIENT;
import static cid.http.shuffling.ShufflingUtil.BOB_RECIPIENT;
import static cid.http.shuffling.ShufflingUtil.CHUCK_RECIPIENT;
import static cid.http.shuffling.ShufflingUtil.DAVE_RECIPIENT;
import static cid.http.shuffling.ShufflingUtil.broadcast;
import static cid.http.shuffling.ShufflingUtil.cancel;
import static cid.http.shuffling.ShufflingUtil.create;
import static cid.http.shuffling.ShufflingUtil.createAssetShuffling;
import static cid.http.shuffling.ShufflingUtil.createCurrencyShuffling;
import static cid.http.shuffling.ShufflingUtil.defaultHoldingShufflingAmount;
import static cid.http.shuffling.ShufflingUtil.defaultShufflingAmount;
import static cid.http.shuffling.ShufflingUtil.getShuffling;
import static cid.http.shuffling.ShufflingUtil.getShufflingParticipants;
import static cid.http.shuffling.ShufflingUtil.process;
import static cid.http.shuffling.ShufflingUtil.register;
import static cid.http.shuffling.ShufflingUtil.shufflingAsset;
import static cid.http.shuffling.ShufflingUtil.shufflingCurrency;
import static cid.http.shuffling.ShufflingUtil.startShuffler;
import static cid.http.shuffling.ShufflingUtil.stopShuffler;
import static cid.http.shuffling.ShufflingUtil.verify;
...
public class TestAutomatedShuffling extends BlockchainTest {
    ...
    public void successfulShuffling() {
        ...
        Assert.assertEquals(-(defaultShufflingAmount + 11 * Constants.ONE_CID), ALICE.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-Constants.ONE_CID, BOB.getBalanceDiff());
        Assert.assertEquals(-(defaultShufflingAmount + Constants.ONE_CID), BOB.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-Constants.ONE_CID, CHUCK.getBalanceDiff());
        Assert.assertEquals(-(defaultShufflingAmount + Constants.ONE_CID), CHUCK.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-Constants.ONE_CID, DAVE.getBalanceDiff());
        Assert.assertEquals(-(defaultShufflingAmount + Constants.ONE_CID), DAVE.getUnconfirmedBalanceDiff());
        ...
        Assert.assertEquals(-(defaultShufflingAmount + 12 * Constants.ONE_CID), ALICE.getBalanceDiff());
        Assert.assertEquals(-(defaultShufflingAmount + 12 * Constants.ONE_CID), ALICE.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-(defaultShufflingAmount + 12 * Constants.ONE_CID), BOB.getBalanceDiff());
        Assert.assertEquals(-(defaultShufflingAmount + 12 * Constants.ONE_CID), BOB.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-(defaultShufflingAmount + 12 * Constants.ONE_CID), CHUCK.getBalanceDiff());
        Assert.assertEquals(-(defaultShufflingAmount + 12 * Constants.ONE_CID), CHUCK.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-(defaultShufflingAmount + 12 * Constants.ONE_CID), DAVE.getBalanceDiff());
        Assert.assertEquals(-(defaultShufflingAmount + 12 * Constants.ONE_CID), DAVE.getUnconfirmedBalanceDiff());
        ...
        Assert.assertEquals(48 * Constants.ONE_CID, FORGY.getBalanceDiff());
        Assert.assertEquals(48 * Constants.ONE_CID, FORGY.getUnconfirmedBalanceDiff());
    ...
    public void successfulAssetShuffling() {
        ...
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + 12 * Constants.ONE_CID), ALICE.getBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + 12 * Constants.ONE_CID), ALICE.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + 12 * Constants.ONE_CID), BOB.getBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + 12 * Constants.ONE_CID), BOB.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + 12 * Constants.ONE_CID), CHUCK.getBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + 12 * Constants.ONE_CID), CHUCK.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + 12 * Constants.ONE_CID), DAVE.getBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + 12 * Constants.ONE_CID), DAVE.getUnconfirmedBalanceDiff());
    ...
    public void processingNotStarted() {
        ...
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + Constants.ONE_CID), ALICE.getBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + Constants.ONE_CID), ALICE.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-Constants.ONE_CID, BOB.getBalanceDiff());
        Assert.assertEquals(-Constants.ONE_CID, BOB.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-Constants.ONE_CID, CHUCK.getBalanceDiff());
        Assert.assertEquals(-Constants.ONE_CID, CHUCK.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-Constants.ONE_CID, DAVE.getBalanceDiff());
        Assert.assertEquals(-Constants.ONE_CID, DAVE.getUnconfirmedBalanceDiff());
        ...
        Assert.assertEquals(4 * Constants.ONE_CID + Constants.SHUFFLING_DEPOSIT_NQT, FORGY.getBalanceDiff());
        Assert.assertEquals(4 * Constants.ONE_CID + Constants.SHUFFLING_DEPOSIT_NQT, FORGY.getUnconfirmedBalanceDiff());
    ...
    public void tooManyParticipants() {
        ...
        Assert.assertEquals(3 * Constants.ONE_CID + Constants.SHUFFLING_DEPOSIT_NQT, FORGY.getBalanceDiff());
        Assert.assertEquals(3 * Constants.ONE_CID + Constants.SHUFFLING_DEPOSIT_NQT, FORGY.getUnconfirmedBalanceDiff());
    ...
    public void processingNotFinished() {
        ...
        Assert.assertEquals(-11 * Constants.ONE_CID, ALICE.getBalanceDiff());
        Assert.assertEquals(-11 * Constants.ONE_CID, ALICE.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-11 * Constants.ONE_CID, BOB.getBalanceDiff());
        Assert.assertEquals(-11 * Constants.ONE_CID, BOB.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-11 * Constants.ONE_CID, CHUCK.getBalanceDiff());
        Assert.assertEquals(-11 * Constants.ONE_CID, CHUCK.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + Constants.ONE_CID), DAVE.getBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + Constants.ONE_CID), DAVE.getUnconfirmedBalanceDiff());
        ...
        Assert.assertEquals(34 * Constants.ONE_CID + Constants.SHUFFLING_DEPOSIT_NQT, FORGY.getBalanceDiff());
        Assert.assertEquals(34 * Constants.ONE_CID + Constants.SHUFFLING_DEPOSIT_NQT, FORGY.getUnconfirmedBalanceDiff());
    ...
    public void verifyNotFinished() {
        ...
        Assert.assertEquals(-12 * Constants.ONE_CID, ALICE.getBalanceDiff());
        Assert.assertEquals(-12 * Constants.ONE_CID, ALICE.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-12 * Constants.ONE_CID, BOB.getBalanceDiff());
        Assert.assertEquals(-12 * Constants.ONE_CID, BOB.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + 11 * Constants.ONE_CID), CHUCK.getBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + 11 * Constants.ONE_CID), CHUCK.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-12 * Constants.ONE_CID, DAVE.getBalanceDiff());
        Assert.assertEquals(-12 * Constants.ONE_CID, DAVE.getUnconfirmedBalanceDiff());
        ...
        Assert.assertEquals(47 * Constants.ONE_CID + Constants.SHUFFLING_DEPOSIT_NQT, FORGY.getBalanceDiff());
        Assert.assertEquals(47 * Constants.ONE_CID + Constants.SHUFFLING_DEPOSIT_NQT, FORGY.getUnconfirmedBalanceDiff());
    ...
    public void cancelAfterVerifyChuck() {
        ...
        Assert.assertEquals(-22 * Constants.ONE_CID, ALICE.getBalanceDiff());
        Assert.assertEquals(-22 * Constants.ONE_CID, ALICE.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-22 * Constants.ONE_CID, BOB.getBalanceDiff());
        Assert.assertEquals(-22 * Constants.ONE_CID, BOB.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + 21 * Constants.ONE_CID), CHUCK.getBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + 21 * Constants.ONE_CID), CHUCK.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-12 * Constants.ONE_CID, DAVE.getBalanceDiff());
        Assert.assertEquals(-12 * Constants.ONE_CID, DAVE.getUnconfirmedBalanceDiff());
        ...
        Assert.assertEquals(77 * Constants.ONE_CID + Constants.SHUFFLING_DEPOSIT_NQT, FORGY.getBalanceDiff());
        Assert.assertEquals(77 * Constants.ONE_CID + Constants.SHUFFLING_DEPOSIT_NQT, FORGY.getUnconfirmedBalanceDiff());
    ...
    public void cancelAfterVerifyChuckInvalidKeysAlice() {
        ...
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + 22 * Constants.ONE_CID), ALICE.getBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + 22 * Constants.ONE_CID), ALICE.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-22 * Constants.ONE_CID, BOB.getBalanceDiff());
        Assert.assertEquals(-22 * Constants.ONE_CID, BOB.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-21 * Constants.ONE_CID, CHUCK.getBalanceDiff());
        Assert.assertEquals(-21 * Constants.ONE_CID, CHUCK.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-12 * Constants.ONE_CID, DAVE.getBalanceDiff());
        Assert.assertEquals(-12 * Constants.ONE_CID, DAVE.getUnconfirmedBalanceDiff());
    ...
    public void badProcessDataAlice() {
        ...
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + 11 * Constants.ONE_CID), ALICE.getBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + 11 * Constants.ONE_CID), ALICE.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-11 * Constants.ONE_CID, BOB.getBalanceDiff());
        Assert.assertEquals(-11 * Constants.ONE_CID, BOB.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-1 * Constants.ONE_CID, CHUCK.getBalanceDiff());
        Assert.assertEquals(-1 * Constants.ONE_CID, CHUCK.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-1 * Constants.ONE_CID, DAVE.getBalanceDiff());
        Assert.assertEquals(-1 * Constants.ONE_CID, DAVE.getUnconfirmedBalanceDiff());
        ...
        Assert.assertEquals(24 * Constants.ONE_CID + Constants.SHUFFLING_DEPOSIT_NQT, FORGY.getBalanceDiff());
        Assert.assertEquals(24 * Constants.ONE_CID + Constants.SHUFFLING_DEPOSIT_NQT, FORGY.getUnconfirmedBalanceDiff());
    ...
    public void modifiedProcessDataBob() {
        ...
        Assert.assertEquals(-21 * Constants.ONE_CID, ALICE.getBalanceDiff());
        Assert.assertEquals(-21 * Constants.ONE_CID, ALICE.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + (bobCancelFailed ? 11 : 21) * Constants.ONE_CID), BOB.getBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + (bobCancelFailed ? 11 : 21) * Constants.ONE_CID), BOB.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-11 * Constants.ONE_CID, CHUCK.getBalanceDiff());
        Assert.assertEquals(-11 * Constants.ONE_CID, CHUCK.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-1 * Constants.ONE_CID, DAVE.getBalanceDiff());
        Assert.assertEquals(-1 * Constants.ONE_CID, DAVE.getUnconfirmedBalanceDiff());
        ...
        Assert.assertEquals((bobCancelFailed ? 44 : 54) * Constants.ONE_CID + Constants.SHUFFLING_DEPOSIT_NQT, FORGY.getBalanceDiff());
        Assert.assertEquals((bobCancelFailed ? 44 : 54) * Constants.ONE_CID + Constants.SHUFFLING_DEPOSIT_NQT, FORGY.getUnconfirmedBalanceDiff());
    ...
    public void duplicateProcessDataBob() {
        ...
        Assert.assertEquals(-21 * Constants.ONE_CID, ALICE.getBalanceDiff());
        Assert.assertEquals(-21 * Constants.ONE_CID, ALICE.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + 21 * Constants.ONE_CID), BOB.getBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + 21 * Constants.ONE_CID), BOB.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-11 * Constants.ONE_CID, CHUCK.getBalanceDiff());
        Assert.assertEquals(-11 * Constants.ONE_CID, CHUCK.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-1 * Constants.ONE_CID, DAVE.getBalanceDiff());
        Assert.assertEquals(-1 * Constants.ONE_CID, DAVE.getUnconfirmedBalanceDiff());
        ...
        Assert.assertEquals(54 * Constants.ONE_CID + Constants.SHUFFLING_DEPOSIT_NQT, FORGY.getBalanceDiff());
        Assert.assertEquals(54 * Constants.ONE_CID + Constants.SHUFFLING_DEPOSIT_NQT, FORGY.getUnconfirmedBalanceDiff());
    ...
    public void modifiedProcessDataChuck() {
        ...
        Assert.assertEquals(-21 * Constants.ONE_CID, ALICE.getBalanceDiff());
        Assert.assertEquals(-21 * Constants.ONE_CID, ALICE.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-21 * Constants.ONE_CID, BOB.getBalanceDiff());
        Assert.assertEquals(-21 * Constants.ONE_CID, BOB.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + (chuckCancelFailed ? 11 : 21) * Constants.ONE_CID), CHUCK.getBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + (chuckCancelFailed ? 11 : 21) * Constants.ONE_CID), CHUCK.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-12 * Constants.ONE_CID, DAVE.getBalanceDiff());
        Assert.assertEquals(-12 * Constants.ONE_CID, DAVE.getUnconfirmedBalanceDiff());
        ...
        Assert.assertEquals((chuckCancelFailed ? 65 : 75) * Constants.ONE_CID + Constants.SHUFFLING_DEPOSIT_NQT, FORGY.getBalanceDiff());
        Assert.assertEquals((chuckCancelFailed ? 65 : 75) * Constants.ONE_CID + Constants.SHUFFLING_DEPOSIT_NQT, FORGY.getUnconfirmedBalanceDiff());
    ...
    public void modifiedRecipientKeysDave() {
        ...
        Assert.assertEquals(-65 * Constants.ONE_CID, ALICE.getBalanceDiff() + BOB.getBalanceDiff() + CHUCK.getBalanceDiff());
    ...
    public void duplicateProcessDataChuck() {
        ...
        Assert.assertEquals(-11 * Constants.ONE_CID, BOB.getBalanceDiff());
        Assert.assertEquals(-11 * Constants.ONE_CID, BOB.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + Constants.ONE_CID), CHUCK.getBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + Constants.ONE_CID), CHUCK.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-1 * Constants.ONE_CID, DAVE.getBalanceDiff());
        Assert.assertEquals(-1 * Constants.ONE_CID, DAVE.getUnconfirmedBalanceDiff());
    ...
    public void maxShufflingSize() {
        ...
        for (int i = 0; i < n + 5; i++) {
            generateBlock();
            Block block = Cid.getBlockchain().getLastBlock();
        ...
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + 12 * Constants.ONE_CID) + 100 * Constants.ONE_CID, participants[n - 1].getBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + 12 * Constants.ONE_CID) + 100 * Constants.ONE_CID, participants[n - 1].getUnconfirmedBalanceDiff());
