...
import cid.http.twophased.TestCreateTwoPhased.TwoPhasedMoneyTransferBuilder;
...
public class TestApproveTransaction extends BlockchainTest {
    ...
    public void validVoteCasting() {
        ...
        APICall apiCall = new TwoPhasedMoneyTransferBuilder()
                .finishHeight(Cid.getBlockchain().getHeight() + duration)
                .build();
        ...
        Assert.assertEquals(-50 * Constants.ONE_CID - 2 * Constants.ONE_CID, ALICE.getBalanceDiff());
        Assert.assertEquals(50 * Constants.ONE_CID, BOB.getBalanceDiff());
    ...
    public void invalidVoteCasting() {
        ...
        Assert.assertEquals("ALICE balance: ", -2 * Constants.ONE_CID, ALICE.getBalanceDiff());
    ...
    public void sendMoneyPhasedNoVoting() {
        ...
        Assert.assertEquals(-100 * Constants.ONE_CID - fee, ALICE.getUnconfirmedBalanceDiff());
        // Recipient
        ...
        // Sender
        Assert.assertEquals(-100 * Constants.ONE_CID - fee, ALICE.getBalanceDiff());
        Assert.assertEquals(-100 * Constants.ONE_CID - fee, ALICE.getUnconfirmedBalanceDiff());
        // Recipient
