...
public class TokenTest extends BlockchainTest {
    ...
    public void testParseValidToken() throws Exception {
        ...
        Token actual = Token.parseToken(token, "http://cid.org");
    ...
    public void testGenerateToken() throws Exception {
        ...
        String tokenString = Token.generateToken("secret", "http://cid.org");
        int end = Cid.getEpochTime();
        Token token = Token.parseToken(tokenString, "http://cid.org");
    ...
    public void emptySecret() throws Exception {
        String tokenString = Token.generateToken("", "http://cid.org");
        Token token = Token.parseToken(tokenString, "http://cid.org");
        assertTrue(token.isValid());
    }
