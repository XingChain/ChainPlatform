...
public interface Transaction {
    ...
    interface Builder {
        ...
        Transaction build() throws CidException.NotValidException;

        Transaction build(String secretPhrase) throws CidException.NotValidException;
    ...
    void validate() throws CidException.ValidationException;
