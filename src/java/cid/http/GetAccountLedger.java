 ...
 * account ledger tracks all account changes as determined by the cid.ledgerAccounts,
 * cid.ledgerLogUnconfirmed and cid.ledgerTrimKeep properties.
 * </p>
 * <table>
 ...
 *           The administrator password is required if more than cid.maxAPIRecords entries are to be searched.
 *       </td>
 *     </tr>
 *     <tr>
 *       <td>event</td>
 ...
 *           The maximum number of entries returned is limited by the cid.maxAPIRecords property
 ...
 *     <tr>
 *       <td>CID_BALANCE</td>
 *       <td>Change in the CID balance for the account.  There is no 'holding'.</td>
 *     </tr>
 *     <tr>
 ...
 *     </tr>
 *     <tr>
 *       <td>UNCONFIRMED_CID_BALANCE</td>
 *       <td>Change in the unconfirmed CID balance for the account.  There is no 'holding'.</td>
 *     </tr>
 *   </tbody>
 * </table>
 */
public class GetAccountLedger extends APIServlet.APIRequestHandler {
     ...
     * @return                      API response
     * @throws  CidException        Invalid request
     */
    @Override
