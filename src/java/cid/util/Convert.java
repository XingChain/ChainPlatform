...
public final class Convert {
    ...
    public static String readString(ByteBuffer buffer, int numBytes, int maxLength) throws CidException.NotValidException {
        if (numBytes > 3 * maxLength) {
            throw new CidException.NotValidException("Max parameter length exceeded");
        }
    ...
    public static long parseCID(String cid) {
        return parseStringFraction(cid, 8, Constants.MAX_BALANCE_CID);
    }
