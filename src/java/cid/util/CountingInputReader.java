...
import cid.CidException.CidIOException;
...
public class CountingInputReader extends FilterReader {
     ...
     * @throws  CidIOException      Maximum count exceeded
     */
    private void incCount(long c) throws CidIOException {
        count += c;
        if (count > limit)
            throw new CidIOException("Maximum size exceeded: " + count);
    }
}
