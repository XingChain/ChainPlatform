...
public final class Constants {
    ...
    public static final boolean isTestnet = Cid.getBooleanProperty("cid.isTestnet");
    public static final boolean isOffline = Cid.getBooleanProperty("cid.isOffline");
    public static final boolean isLightClient = Cid.getBooleanProperty("cid.isLightClient");
    public static final String customLoginWarning = Cid.getStringProperty("cid.customLoginWarning", null, false, "UTF-8");

    public static final String COIN_SYMBOL = "CID";
    public static final String ACCOUNT_PREFIX = "CID";
    public static final String PROJECT_NAME  = "ChainPlatform";
    public static final int MAX_NUMBER_OF_TRANSACTIONS = Cid.getIntProperty("cid.maxNumberOfTransactions", 255);
    public static final int MIN_TRANSACTION_SIZE = 176;
    public static final int MAX_PAYLOAD_LENGTH = MAX_NUMBER_OF_TRANSACTIONS * MIN_TRANSACTION_SIZE;
    public static final long MAX_BALANCE_CID = 1000000000;
    public static final long ONE_CID = 100000000;
    public static final long MAX_BALANCE_NQT = MAX_BALANCE_CID * ONE_CID;

    public static final int BLOCK_TIME = 60;
    public static final long INITIAL_BASE_TARGET = BigInteger.valueOf(2).pow(63).divide(BigInteger.valueOf(BLOCK_TIME * MAX_BALANCE_CID)).longValue(); //153722867;
    public static final long MAX_BASE_TARGET = INITIAL_BASE_TARGET * (isTestnet ? MAX_BALANCE_CID : 50);
    ...
    public static final int MAX_ROLLBACK = Math.max(Cid.getIntProperty("cid.maxRollback"), 720);
    public static final int GUARANTEED_BALANCE_CONFIRMATIONS = isTestnet ? Cid.getIntProperty("cid.testnetGuaranteedBalanceConfirmations", 1440) : 1440;
    public static final int LEASING_DELAY = isTestnet ? Cid.getIntProperty("cid.testnetLeasingDelay", 1440) : 1440;
    public static final long MIN_FORGING_BALANCE_NQT = 1000 * ONE_CID;

    public static final int MAX_TIMEDRIFT = 15; // allow up to 15 s clock difference
    public static final int FORGING_DELAY = Cid.getIntProperty("cid.forgingDelay");
    public static final int FORGING_SPEEDUP = Cid.getIntProperty("cid.forgingSpeedup");
    public static final int BATCH_COMMIT_SIZE = Cid.getIntProperty("cid.batchCommitSize", Integer.MAX_VALUE);
    ...
    static {
        int maxPrunableLifetime = Cid.getIntProperty("cid.maxPrunableLifetime");
        ENABLE_PRUNING = maxPrunableLifetime >= 0;
        MAX_PRUNABLE_LIFETIME = ENABLE_PRUNING ? Math.max(maxPrunableLifetime, MIN_PRUNABLE_LIFETIME) : Integer.MAX_VALUE;
    }
    public static final boolean INCLUDE_EXPIRED_PRUNABLE = Cid.getBooleanProperty("cid.includeExpiredPrunable");
    ...
    static final long UNCONFIRMED_POOL_DEPOSIT_NQT = (isTestnet ? 50 : 100) * ONE_CID;
    public static final long SHUFFLING_DEPOSIT_NQT = (isTestnet ? 7 : 1000) * ONE_CID;

    public static final boolean correctInvalidFees = Cid.getBooleanProperty("cid.correctInvalidFees");
