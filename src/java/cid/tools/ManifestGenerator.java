...
import cid.Cid;
import cid.env.service.CidService_ServiceManagement;
...
public class ManifestGenerator {
    ...
    public static void main(String[] args) {
        ...
        manifestGenerator.generate("./resource/cid.manifest.mf", Cid.class.getCanonicalName(), "./lib");
        String serviceClassName = CidService_ServiceManagement.class.getCanonicalName();
        serviceClassName = serviceClassName.substring(0, serviceClassName.length() - "_ServiceManagement".length());
        manifestGenerator.generate("./resource/cidservice.manifest.mf", serviceClassName, "./lib");
    }
