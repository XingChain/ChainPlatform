...
public abstract class CidException extends Exception {

    protected CidException() {
        super();
    }

    protected CidException(String message) {
        super(message);
    }

    protected CidException(String message, Throwable cause) {
        super(message, cause);
    }

    protected CidException(Throwable cause) {
        super(cause);
    }

    public static abstract class ValidationException extends CidException {
    ...
    public static final class CidIOException extends IOException {

        public CidIOException(String message) {
            super(message);
        }

        public CidIOException(String message, Throwable cause) {
            super(message, cause);
        }
