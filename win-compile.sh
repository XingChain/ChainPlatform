...
javac -encoding utf8 -sourcepath "${SP}" -classpath "${CP}" -d classes/ src/java/cid/*.java src/java/cid/*/*.java src/java/cid/*/*/*.java src/java/ciddesktop/*.java || exit 1

echo "cid class files compiled successfully"
